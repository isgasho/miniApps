...
values in `mm,cm,in,pt,pc,pi` like `12cm` `12mm` `23.7cm` etc or can be **float** values like `12.34` but has to `>=0`
...
3.  [Page Margin](#page-margin)

4.  [Document Background](#document-background)

5.  [Document Border](#document-border)
...
These tags would contain text that would be inserted in the following properties of the document i.e `<Title>Demo Doc</Title>`
