...
const (
	...
	//Borders props: style={0-193} size={int} space={int}
...
func initWhiteListSelfTags() {
	...
	WhiteListSelfTags["symbol"] = Symbol
...
func initWhiteListStyleMap() {
	...
	WhiteListStyleTags["small"] = SmallCaps
	...
	WhiteListStyleTags["sub"] = SubScript
	WhiteListStyleTags["sup"] = SuperScript
